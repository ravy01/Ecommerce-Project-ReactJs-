      ...
      <div className="w-full min-h-[150px] flex items-center gap-x-4">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="flex justify-between mb-2">
            ...
            <Link
              to={`/product/${id}`}
              className="text-sm uppercase font-medium max-w-[240px]  text-dark"
            >
              {title}
            </Link>
            {/* remove icon */}
          ...
          <div className="flex gap-x-2 h-[36px] text-sm">
            {/* quantity */}
            <div className="flex flex-1 max-w-[100px] items-center h-full border text-red-500 font-medium ">
            ...
            {/* item price */}
            <div className="flex flex-1 justify-around items-center text-red-500">
              $ {price}
            </div>
            {/* final price */}
